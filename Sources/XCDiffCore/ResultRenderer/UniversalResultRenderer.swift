...
final class UniversalResultRenderer: ResultRenderer {
    ...
    private func createResultRenderer(with outputBuffer: AnyOutput<String>) -> ProjectCompareResultRenderer {
        ...
        case .git:
            return createGitRenderer(outputBuffer: outputBuffer)
        }
    }
    ...
    private func createGitRenderer(outputBuffer: AnyOutput<String>) -> ProjectCompareResultRenderer {
        return TextProjectCompareResultRenderer(renderer: GitDiffRenderer(output: outputBuffer),
                                                verbose: verbose)
    }
}
